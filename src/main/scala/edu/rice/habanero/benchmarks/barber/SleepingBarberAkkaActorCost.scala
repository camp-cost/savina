 ...
 */
object SleepingBarberAkkaActorCost {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new SleepingBarberAkkaActorCost)
  }

  private final class SleepingBarberAkkaActorCost extends Benchmark {
