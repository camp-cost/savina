 ...
 */
object PhilosopherAkkaActorCost {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new PhilosopherAkkaActorCost)
  }

  private final class PhilosopherAkkaActorCost extends Benchmark {
