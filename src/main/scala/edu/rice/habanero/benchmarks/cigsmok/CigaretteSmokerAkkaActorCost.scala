 ...
 */
object CigaretteSmokerAkkaActorCost {

  def main(args: Array[String]) {
    BenchmarkRunner.runBenchmark(args, new CigaretteSmokerAkkaActorCost)
  }

  private final class CigaretteSmokerAkkaActorCost extends Benchmark {
